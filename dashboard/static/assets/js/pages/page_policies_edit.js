/*
*  NGFW Admin
*  page_policies_edit.js (page_policies_edit.html)
*/

$(function() {
    // characters/words counter
//    ngfw_policies_edit.char_words_counter();
    // ionrangeSlider
//    ngfw_policies_edit.rangeSlider();
    // ngfw_policies_edit selects
    ngfw_policies_edit.init();
//    ngfw_policies_edit.adv_selects();
    ngfw_policies_edit.editPolicy();
    // masked_inputs
//    ngfw_policies_edit.masked_inputs();
...
//        Identity User And Groups
        ...
        ngfw_policies_edit.write_summary(  policy_status_val,
            policy_log_val,
            policy_action_val,
            policy_src_zone_val,
...
//            summary_text += pol_dnat;
    ...
    editPolicy: function() {
        $(document).ready(function(){
            $("#policies_edit_submit").click(function(){
...
/************************************************************************************/
                ...
                var policy_id_val = $('input[name=policy_id]').val();
...
//                return ;
                ...
                $.post("php/views/page_policies_edit_backend.php",
                {
