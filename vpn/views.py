...
def tunnel_create(request):
    try:
        new_tunnel = Tunnel(
            ...
            auth_method=request.POST["AuthMethod"],
...
def tunnel_read(request):
    ...
    for each_tunnel in tunnels:
        records.append({
            ...
            'AuthMethod': each_tunnel.auth_method,
...
def tunnel_update(request):
    try:
        ...
        requested_tunnel.auth_method = request.POST["AuthMethod"]
...
def tunnel_view(request):
    ...
    record = [{
        ...
        'AuthMethod': requested_tunnel.auth_method,
