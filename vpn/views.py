...
def profile_create(request):
    try:
        new_profile = Profile(
            ...
            phase2_auth=request.POST["Phase2_Auth"],
            phase2_dhg=request.POST["Phase2_Dhg"],
...
def profile_read(request):
    ...
    for each_profile in profiles:
        records.append({
            ...
            'Phase2_Auth':each_profile.phase2_auth,
            'Phase2_Dhg':each_profile.phase2_dhg,
...
def profile_view(request):
    ...
    record = [{
        ...
        'Phase2_Auth':requested_profile.phase2_auth,
        'Phase2_Dhg':requested_profile.phase2_dhg,
